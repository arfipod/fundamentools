window.I18N = {
  es: {
    ...
    'industry.auto': 'Industria GICS: Auto (inferir)',
    industryLensTitle: 'KPIs clave por industria',
    industryLensEmpty: 'No se detectaron KPIs de este perfil con los datos financieros pegados.',
    industryValuation: 'Valoración a priorizar',
    industryProfile: 'Perfil',
  ...
  en: {
    ...
    'industry.auto': 'GICS industry: Auto (infer)',
    industryLensTitle: 'Industry KPI lens',
    industryLensEmpty: 'No profile KPIs were detected in the pasted financial input.',
    industryValuation: 'Preferred valuation lens',
